 ...
 *
 * <ul>
 *     <li><em>Adapter:</em> A subclass of {@link com.opensource.widget.RecyclerView.Adapter} responsible for providing views
...
public class RecyclerView extends ViewGroup {
     ...
     * @see #setAdapter(com.opensource.widget.RecyclerView.Adapter)
     */
    ...
    /**
     * Set the {@link com.opensource.widget.RecyclerView.LayoutManager} that this RecyclerView will use.
     *
     * <p>In contrast to other adapter-backed views such as {@link android.widget.ListView}
     * or {@link android.widget.GridView}, RecyclerView allows client code to provide custom
     * layout arrangements for child views. These arrangements are controlled by the
     * {@link com.opensource.widget.RecyclerView.LayoutManager}. A LayoutManager must be provided for RecyclerView to function.</p>
     *
    ...
    /**
     * Return the {@link com.opensource.widget.RecyclerView.LayoutManager} currently responsible for
    ...
    /**
     * Retrieve this RecyclerView's {@link com.opensource.widget.RecyclerView.RecycledViewPool}. This method will never return null;
     * if no pool is set for this view a new one will be created. See
     * {@link #setRecycledViewPool(com.opensource.widget.RecyclerView.RecycledViewPool) setRecycledViewPool} for more information.
     *
     * @return The pool used to store recycled item views for reuse.
     * @see #setRecycledViewPool(com.opensource.widget.RecyclerView.RecycledViewPool)
     */
    ...
    /**
     * Add an {@link com.opensource.widget.RecyclerView.ItemDecoration} to this RecyclerView. Item decorations can
    ...
    /**
     * Remove an {@link com.opensource.widget.RecyclerView.ItemDecoration} from this RecyclerView.
     *
     * <p>The given decoration will no longer impact the measurement and drawing of
     * item views.</p>
     *
     * @param decor Decoration to remove
     * @see #addItemDecoration(com.opensource.widget.RecyclerView.ItemDecoration)
     */
     ...
     * {@link com.opensource.widget.RecyclerView.LayoutManager#scrollToPosition(int)}
     * @param position Scroll to this adapter position
     * @see com.opensource.widget.RecyclerView.LayoutManager#scrollToPosition(int)
     */
     ...
     * {@link com.opensource.widget.RecyclerView.LayoutManager#smoothScrollToPosition(com.opensource.widget.RecyclerView, com.opensource.widget.RecyclerView.State, int)} and create a
     * {@link com.opensource.widget.RecyclerView.SmoothScroller}.
     * <p>
     * {@link com.opensource.widget.RecyclerView.LayoutManager} is responsible for creating the actual scroll action. If you want to
     * provide a custom smooth scroll logic, override
     * {@link com.opensource.widget.RecyclerView.LayoutManager#smoothScrollToPosition(com.opensource.widget.RecyclerView, com.opensource.widget.RecyclerView.State, int)} in your
     * LayoutManager.
     *
     * @param position The adapter position to scroll to
     * @see com.opensource.widget.RecyclerView.LayoutManager#smoothScrollToPosition(com.opensource.widget.RecyclerView, com.opensource.widget.RecyclerView.State, int)
     */
     ...
     * {@link com.opensource.widget.RecyclerView.LayoutManager#computeHorizontalScrollOffset(com.opensource.widget.RecyclerView.State)} in your
     * LayoutManager. </p>
     *
     * @return The horizontal offset of the scrollbar's thumb
     * @see com.opensource.widget.RecyclerView.LayoutManager#computeHorizontalScrollOffset
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link com.opensource.widget.RecyclerView.LayoutManager#computeHorizontalScrollExtent(com.opensource.widget.RecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The horizontal extent of the scrollbar's thumb
     * @see com.opensource.widget.RecyclerView.LayoutManager#computeHorizontalScrollExtent(com.opensource.widget.RecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link com.opensource.widget.RecyclerView.LayoutManager#computeHorizontalScrollRange(com.opensource.widget.RecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The total horizontal range represented by the vertical scrollbar
     * @see com.opensource.widget.RecyclerView.LayoutManager#computeHorizontalScrollRange(com.opensource.widget.RecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link com.opensource.widget.RecyclerView.LayoutManager#computeVerticalScrollOffset(com.opensource.widget.RecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The vertical offset of the scrollbar's thumb
     * @see com.opensource.widget.RecyclerView.LayoutManager#computeVerticalScrollOffset
     * (RecyclerView.Adapter)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link com.opensource.widget.RecyclerView.LayoutManager#computeVerticalScrollExtent(com.opensource.widget.RecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The vertical extent of the scrollbar's thumb
     * @see com.opensource.widget.RecyclerView.LayoutManager#computeVerticalScrollExtent(com.opensource.widget.RecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link com.opensource.widget.RecyclerView.LayoutManager#computeVerticalScrollRange(com.opensource.widget.RecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The total vertical range represented by the vertical scrollbar
     * @see com.opensource.widget.RecyclerView.LayoutManager#computeVerticalScrollRange(com.opensource.widget.RecyclerView.State)
     */
    @Override
    ...
    /**
     * Add an {@link com.opensource.widget.RecyclerView.OnItemTouchListener} to intercept touch events before they are dispatched
     * to child views or this view's standard scrolling behavior.
     *
     * <p>Client code may use listeners to implement item manipulation behavior. Once a listener
     * returns true from
     * {@link com.opensource.widget.RecyclerView.OnItemTouchListener#onInterceptTouchEvent(com.opensource.widget.RecyclerView, android.view.MotionEvent)} its
     * {@link com.opensource.widget.RecyclerView.OnItemTouchListener#onTouchEvent(com.opensource.widget.RecyclerView, android.view.MotionEvent)} method will be called
    ...
    /**
     * Remove an {@link com.opensource.widget.RecyclerView.OnItemTouchListener}. It will no longer be able to intercept touch events.
     *
    ...
    /**
     * Sets the {@link com.opensource.widget.RecyclerView.ItemAnimator} that will handle animations involving changes
     * to the items in this RecyclerView. By default, RecyclerView instantiates and
     * uses an instance of {@link com.opensource.widget.DefaultItemAnimator}. Whether item animations are
     * enabled for the RecyclerView depends on the ItemAnimator and whether
     * the LayoutManager {@link com.opensource.widget.RecyclerView.LayoutManager#supportsPredictiveItemAnimations()
     ...
     * uses an instance of {@link com.opensource.widget.DefaultItemAnimator}.
     *
     ...
     * PERSISTENT views are moved ({@link com.opensource.widget.RecyclerView.ItemAnimator#animateMove(com.opensource.widget.RecyclerView.ViewHolder, int, int, int, int)})
     * REMOVED views are removed ({@link com.opensource.widget.RecyclerView.ItemAnimator#animateRemove(com.opensource.widget.RecyclerView.ViewHolder)})
     * ADDED views are added ({@link com.opensource.widget.RecyclerView.ItemAnimator#animateAdd(com.opensource.widget.RecyclerView.ViewHolder)})
    ...
    /**
     * Retrieve the {@link com.opensource.widget.RecyclerView.ViewHolder} for the given child view.
     *
     ...
     * use an Adapter with {@link com.opensource.widget.RecyclerView.Adapter#setHasStableIds(boolean) stableIds} to
     ...
     * Useful for implementing simple scrolling in {@link com.opensource.widget.RecyclerView.LayoutManager LayoutManagers}.
     *
     ...
     * {@link com.opensource.widget.RecyclerView.LayoutManager} measures or lays out the view and is a good time to perform these
     * changes.</p>
     *
     ...
     * {@link com.opensource.widget.RecyclerView.LayoutManager} fully detaches the child view from the parent and its window.</p>
     *
     ...
     *
     * <p>Typical use of a Recycler by a {@link com.opensource.widget.RecyclerView.LayoutManager} will be to obtain views for
    ...
    public final class Recycler {
         ...
         *
         * <p>This method should be used by {@link com.opensource.widget.RecyclerView.LayoutManager} implementations to obtain
         * views to represent data from an {@link com.opensource.widget.RecyclerView.Adapter}.</p>
         *
     ...
     * within a {@link com.opensource.widget.RecyclerView}.</p>
     */
    public static abstract class Adapter<VH extends ViewHolder> {
         ...
         *
         * <p>A view is recycled when a {@link com.opensource.widget.RecyclerView.LayoutManager} decides that it no longer
         * needs to be attached to its parent {@link com.opensource.widget.RecyclerView}. This can be because it has
         ...
         * {@link #onViewDetachedFromWindow(com.opensource.widget.RecyclerView.ViewHolder) onViewDetachedFromWindow}
         ...
         * {@link com.opensource.widget.RecyclerView.AdapterDataObserver#onChanged()
         * "something changed"} event if more specific data is not available.</p>
         *
         * <p>Components registering observers with an adapter are responsible for
         * {@link #unregisterAdapterDataObserver(com.opensource.widget.RecyclerView.AdapterDataObserver)
         * unregistering} those observers when finished.</p>
         *
         * @param observer Observer to register
         *
         * @see #unregisterAdapterDataObserver(com.opensource.widget.RecyclerView.AdapterDataObserver)
         */
         ...
         *
         * @see #registerAdapterDataObserver(com.opensource.widget.RecyclerView.AdapterDataObserver)
         */
    ...
    public static abstract class LayoutManager {
         ...
         * rules as outlined in {@link #onLayoutChildren(com.opensource.widget.RecyclerView.Recycler, com.opensource.widget.RecyclerView.State)}.
         ...
         * {@link com.opensource.widget.RecyclerView#setItemAnimator(com.opensource.widget.RecyclerView.ItemAnimator) ItemAnimator} set on the
         ...
         * then there will be two calls to {@link #onLayoutChildren(com.opensource.widget.RecyclerView.Recycler, com.opensource.widget.RecyclerView.State)} to
         ...
         * normal layout operation during {@link #onLayoutChildren(com.opensource.widget.RecyclerView.Recycler, com.opensource.widget.RecyclerView.State)}, the
         * RecyclerView will have enough information to run those animations in a simple
         * way. For example, the default ItemAnimator, {@link com.opensource.widget.DefaultItemAnimator}, will
         ...
         * {@link #onLayoutChildren(com.opensource.widget.RecyclerView.Recycler, com.opensource.widget.RecyclerView.State)}. Supporting predictive animations
         * means that {@link #onLayoutChildren(com.opensource.widget.RecyclerView.Recycler, com.opensource.widget.RecyclerView.State)} will be called twice;
         ...
         * appropriately. Also, {@link com.opensource.widget.RecyclerView.LayoutParams#isItemRemoved() removed} items will
         ...
         * {@link com.opensource.widget.RecyclerView.LayoutParams} for this purpose.</p>
         *
         * <p><em>Important:</em> if you use your own custom <code>LayoutParams</code> type
         * you must also override
         * {@link #checkLayoutParams(com.opensource.widget.RecyclerView.LayoutParams)},
         ...
         * <p>To support smooth scrolling, override this method, create your {@link com.opensource.widget.RecyclerView.SmoothScroller}
         * instance and call {@link #startSmoothScroll(com.opensource.widget.RecyclerView.SmoothScroller)}.
         * </p>
         ...
         * use this method to add views obtained from a {@link com.opensource.widget.RecyclerView.Recycler} using
         * {@link com.opensource.widget.RecyclerView.Recycler#getViewForPosition(int)}.
         *
         ...
         * {@link com.opensource.widget.RecyclerView.Recycler#recycleView(android.view.View)}.
         *
         ...
         * will want to use {@link #detachAndScrapView(android.view.View, com.opensource.widget.RecyclerView.Recycler)}
         ...
         * {@link #attachView(android.view.View, int, com.opensource.widget.RecyclerView.LayoutParams) reattach}
         ...
         * {@link #detachAndScrapView(android.view.View, com.opensource.widget.RecyclerView.Recycler)}  scrapped}.
         *
        ...
        /**
         * Detach a child view and add it to a {@link com.opensource.widget.RecyclerView.Recycler Recycler's} scrap heap.
         *
         ...
         * any insets applied by {@link com.opensource.widget.RecyclerView.ItemDecoration ItemDecorations}.
         *
         * @param child Child view to query
         ...
         * include any current {@link com.opensource.widget.RecyclerView.ItemDecoration ItemDecorations}.
         *
         ...
         * {@link com.opensource.widget.RecyclerView.ItemDecoration ItemDecorations}.
         *
         ...
         * then {@link #onFocusSearchFailed(android.view.View, int, com.opensource.widget.RecyclerView.Recycler, com.opensource.widget.RecyclerView.State)}
         ...
         *                   {@link #setAdapter(com.opensource.widget.RecyclerView.Adapter)} is called with {@code null}.
         */
         ...
         *
         * <p>Read {@link com.opensource.widget.RecyclerView#computeHorizontalScrollExtent()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current state of RecyclerView
         * @return The horizontal extent of the scrollbar's thumb
         * @see com.opensource.widget.RecyclerView#computeHorizontalScrollExtent()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link com.opensource.widget.RecyclerView#computeHorizontalScrollOffset()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The horizontal offset of the scrollbar's thumb
         * @see com.opensource.widget.RecyclerView#computeHorizontalScrollOffset()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link com.opensource.widget.RecyclerView#computeHorizontalScrollRange()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The total horizontal range represented by the vertical scrollbar
         * @see com.opensource.widget.RecyclerView#computeHorizontalScrollRange()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link com.opensource.widget.RecyclerView#computeVerticalScrollExtent()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current state of RecyclerView
         * @return The vertical extent of the scrollbar's thumb
         * @see com.opensource.widget.RecyclerView#computeVerticalScrollExtent()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link com.opensource.widget.RecyclerView#computeVerticalScrollOffset()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The vertical offset of the scrollbar's thumb
         * @see com.opensource.widget.RecyclerView#computeVerticalScrollOffset()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link com.opensource.widget.RecyclerView#computeVerticalScrollRange()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The total vertical range represented by the vertical scrollbar
         * @see com.opensource.widget.RecyclerView#computeVerticalScrollRange()
         */
     ...
     * views (in {@link com.opensource.widget.RecyclerView.ItemDecoration#onDraw(android.graphics.Canvas, com.opensource.widget.RecyclerView) onDraw()} and after the items
     * (in {@link com.opensource.widget.RecyclerView.ItemDecoration#onDrawOver(android.graphics.Canvas, com.opensource.widget.RecyclerView)}.</p>
     */
     ...
     *
     * @see com.opensource.widget.RecyclerView#setOnScrollListener(com.opensource.widget.RecyclerView.OnScrollListener)
     */
     ...
     * a view is recycled.
     *
     * @see com.opensource.widget.RecyclerView#setRecyclerListener(com.opensource.widget.RecyclerView.RecyclerListener)
     */
     ...
     *
     * <p>{@link com.opensource.widget.RecyclerView.Adapter} implementations should subclass ViewHolder and add fields for caching
     * potentially expensive {@link android.view.View#findViewById(int)} results.</p>
     *
     * <p>While {@link com.opensource.widget.RecyclerView.LayoutParams} belong to the {@link com.opensource.widget.RecyclerView.LayoutManager},
     * {@link com.opensource.widget.RecyclerView.ViewHolder ViewHolders} belong to the adapter. Adapters should feel free to use
     ...
     * {@link com.opensource.widget.RecyclerView}. Custom {@link com.opensource.widget.RecyclerView.LayoutManager layout managers} are encouraged
    ...
    /**
     * Observer base class for watching changes to an {@link com.opensource.widget.RecyclerView.Adapter}.
     * See {@link com.opensource.widget.RecyclerView.Adapter#registerAdapterDataObserver(com.opensource.widget.RecyclerView.AdapterDataObserver)}.
     */
     ...
     *
     * @see com.opensource.widget.LinearSmoothScroller
     */
    public static abstract class SmoothScroller {
         ...
         * <p>In each animation step, {@link com.opensource.widget.RecyclerView} will check
         * for the target view and call either
         * {@link #onTargetFound(android.view.View, com.opensource.widget.RecyclerView.State, com.opensource.widget.RecyclerView.SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, com.opensource.widget.RecyclerView.State, com.opensource.widget.RecyclerView.SmoothScroller.Action)} until
         ...
         * cancel any existing {@link com.opensource.widget.RecyclerView.SmoothScroller.Action} updated by
         * {@link #onTargetFound(android.view.View, com.opensource.widget.RecyclerView.State, com.opensource.widget.RecyclerView.SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, com.opensource.widget.RecyclerView.State, com.opensource.widget.RecyclerView.SmoothScroller.Action)}.
         */
         ...
         * {@link com.opensource.widget.RecyclerView#NO_POSITION} if no target view is set.
         */
        ...
        /**
         * @see com.opensource.widget.RecyclerView#getChildPosition(android.view.View)
         */
        ...
        /**
         * @see com.opensource.widget.RecyclerView#getChildCount()
         */
        public int getChildCount() {
        ...
        /**
         * @see com.opensource.widget.RecyclerView.LayoutManager#findViewByPosition(int)
         */
        public View findViewByPosition(int position) {
        ...
        /**
         * @see com.opensource.widget.RecyclerView#scrollToPosition(int)
         */
         ...
         * provided {@link com.opensource.widget.RecyclerView.SmoothScroller.Action} to define the next scroll.</p>
         *
         ...
         * will receive and it should update the provided {@link com.opensource.widget.RecyclerView.SmoothScroller.Action} to define the scroll
         * details towards the target view.
         * @param targetView    The view element which render the target position.
         * @param state         Transient state of RecyclerView
         * @param action        Action instance that you should update to define final scroll action
         *                      towards the targetView
         * @return An {@link com.opensource.widget.RecyclerView.SmoothScroller.Action} to finalize the smooth scrolling
         */
        abstract protected void onTargetFound(View targetView, State state, Action action);

        /**
         * Holds information about a smooth scroll request by a {@link com.opensource.widget.RecyclerView.SmoothScroller}.
         */
    ...
    public static class State {
         ...
         * {@link com.opensource.widget.RecyclerView#NO_POSITION} if there is no target
         * position.
         */
     ...
     * method when each item animation is done ({@link #dispatchRemoveFinished(com.opensource.widget.RecyclerView.ViewHolder)},
     * {@link #dispatchMoveFinished(com.opensource.widget.RecyclerView.ViewHolder)}, or {@link #dispatchAddFinished(com.opensource.widget.RecyclerView.ViewHolder)}).
     *
     * <p>By default, RecyclerView uses {@link com.opensource.widget.DefaultItemAnimator}</p>
     *
     * @see #setItemAnimator(com.opensource.widget.RecyclerView.ItemAnimator)
     */
    public static abstract class ItemAnimator {
         ...
         * is governed by the return values from {@link #animateAdd(com.opensource.widget.RecyclerView.ViewHolder) animateAdd()},
         * {@link #animateMove(com.opensource.widget.RecyclerView.ViewHolder, int, int, int, int) animateMove()}, and
         * {@link #animateRemove(com.opensource.widget.RecyclerView.ViewHolder) animateRemove()}, which inform the
         ...
         * {@link #dispatchRemoveFinished(com.opensource.widget.RecyclerView.ViewHolder)} when done, either
         * immediately (if no animation will occur) or after the animation actually finishes.
         * The return value indicates whether an animation has been set up and whether the
         * ItemAnimators {@link #runPendingAnimations()} method should be called at the
         * next opportunity. This mechanism allows ItemAnimator to set up individual animations
         * as separate calls to {@link #animateAdd(com.opensource.widget.RecyclerView.ViewHolder) animateAdd()},
         * {@link #animateMove(com.opensource.widget.RecyclerView.ViewHolder, int, int, int, int) animateMove()}, and
         * {@link #animateRemove(com.opensource.widget.RecyclerView.ViewHolder) animateRemove()} come in one by one, then
         ...
         * whether and how to animate that change, but must always call
         * {@link #dispatchAddFinished(com.opensource.widget.RecyclerView.ViewHolder)} when done, either
         * immediately (if no animation will occur) or after the animation actually finishes.
         * The return value indicates whether an animation has been set up and whether the
         * ItemAnimators {@link #runPendingAnimations()} method should be called at the
         * next opportunity. This mechanism allows ItemAnimator to set up individual animations
         ...
         * whether and how to animate that change, but must always call
         * {@link #dispatchMoveFinished(com.opensource.widget.RecyclerView.ViewHolder)} when done, either
         * immediately (if no animation will occur) or after the animation actually finishes.
         * The return value indicates whether an animation has been set up and whether the
         * ItemAnimators {@link #runPendingAnimations()} method should be called at the
         * next opportunity. This mechanism allows ItemAnimator to set up individual animations
         ...
         * Also, appropriate dispatch methods (e.g., {@link #dispatchAddFinished(com.opensource.widget.RecyclerView.ViewHolder)}
         ...
         *
         * @see #isRunning(com.opensource.widget.RecyclerView.ItemAnimator.ItemAnimatorFinishedListener)
         */
